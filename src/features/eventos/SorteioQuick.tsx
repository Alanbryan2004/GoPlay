        ...
        <div className="flex items-center gap-1.5">
          ...
          {isJogoAtivo && (
            <button
              ...
              className="px-2.5 py-1.5 bg-slate-100 hover:bg-red-50 hover:text-red-600 text-slate-600 rounded-xl text-xs font-black transition-all cursor-pointer"
            >
              Encerrar
            </button>
          )}
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleAddJogadorAvulso} className="p-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-left space-y-2.5 shadow-xs">
            ...
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-3.5 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl text-xs font-black flex items-center gap-1 cursor-pointer active:scale-95 transition-all shadow-xs"
              >
                <Plus size={15} />
                <span>Add</span>
              </button>
          ...
          <div className="bg-white rounded-3xl p-5 max-w-xs w-full text-center space-y-4 shadow-2xl border border-slate-100">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-750 font-bold rounded-xl text-xs cursor-pointer"
              >
                Voltar ao Jogo
              </button>
              <button
                ...
                className="flex-1 py-2.5 bg-red-600 hover:bg-red-700 text-white font-black rounded-xl text-xs cursor-pointer shadow-md"
              >
                Sim, Encerrar
              </button>
            </div>
